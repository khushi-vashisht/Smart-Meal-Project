  ...
  return (
    ...
    >
      ...
      <Typography variant="h6" color="#666666" textAlign="center" maxWidth={800}>
        SmartMeal's meal planner removes the stress of planning your healthy meals. Just input your info and start enjoying the food you love. Each meal is customized to your body, selected diet style, your allergies, and your preferences.
      </Typography>
      <Typography variant="h5" color="#292929" margin={8} fontWeight={400} textAlign="center">
        Get answers to all your diet-related questions with our AI chatbot.
      </Typography>
