...
import ReactMarkdown from "react-markdown"; // Markdown to Normal Text Form
...
function App() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:6001/meal/askAI`,
        {
          method: "POST",
  ...
  return (
    ...
    >
      ...
      {response && (
        <div style={{ marginTop: "20px", padding: "10px", backgroundColor: "#fff", borderRadius: "10px" }}>
